...
lyr_Polosdecrecimiento_1.set('fieldAliases', {'Polo': 'Polo', 'Clase': 'Clase', 'Limitante_Fisica': 'Limitante_Fisica', 'Limitante_Quimica': 'Limitante_Quimica', 'Capa': 'Capa', 'Ubicacion': 'Ubicacion', });
lyr_CrecimientopotencialISC_2.set('fieldAliases', {'ID': 'ID', 'Nombre': 'Nombre', 'Clase': 'Clase', 'Superficie': 'Superficie', });
lyr_Polosdecrecimiento_1.set('fieldImages', {'Polo': 'TextEdit', 'Clase': 'TextEdit', 'Limitante_Fisica': 'TextEdit', 'Limitante_Quimica': 'TextEdit', 'Capa': 'TextEdit', 'Ubicacion': 'TextEdit', });
lyr_CrecimientopotencialISC_2.set('fieldImages', {'ID': 'Range', 'Nombre': 'TextEdit', 'Clase': 'TextEdit', 'Superficie': 'TextEdit', });
lyr_Polosdecrecimiento_1.set('fieldLabels', {'Polo': 'inline label - always visible', 'Clase': 'inline label - always visible', 'Limitante_Fisica': 'inline label - always visible', 'Limitante_Quimica': 'inline label - always visible', 'Capa': 'no label', 'Ubicacion': 'no label', });
